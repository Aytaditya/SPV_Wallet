...
// const signUpResponse = await authModule.signUp({ email: "adityaaryan531@gmail.com", password: "aditya123" });
// console.log(signUpResponse);

const loginResponse = await authModule.login({ email: "sales@timechainlabs.io", password: "string" });
console.log(loginResponse);

// const loginResponse = await authModule.login({ email: "adityaaryan531@gmail.com", password: "aditya123" });
// console.log(loginResponse);
...
const options = {
    outputs: [
      {
        address: 'adityaaryan531@dev.neucron.io',
        note: 'gurudakshina',
        amount: 10
      }
    ]
